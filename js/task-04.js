...
const inputStringRef = document.querySelector(
  ".task-04__form .form__input--string"
);
const inputNumberRef = document.querySelector(
  ".task-04__form .form__input--number"
);
