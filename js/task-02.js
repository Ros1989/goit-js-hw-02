...
const inputEngravingRef = document.querySelector(
  ".task-02__form .form__input--engraving"
);
const inputPriseRef = document.querySelector(
  ".task-02__form .form__input--prise"
);
...
buttonRef.addEventListener("click", () => {
  ...
  const messageForUser = calculateEngravingPrice(
    inputEngravingRef.value,
    pricePerOne
  );
  console.log(
    `You want engrave "${inputEngravingRef.value}", price per one -  ${pricePerOne}`
  );
  console.log(
